                             ...
                             {item.imageUrl && (
                                 <div className="mt-auto w-full border border-[var(--border-color)] rounded-xl overflow-hidden shadow-md bg-[var(--bg-primary)]">
                                     ...
                                     <img 
                                         ...
                                         className="w-full h-auto max-h-[220px] object-cover filter grayscale-[20%] group-hover:grayscale-0 transition-all duration-700" 
                                     />
                                 </div>
                             )}
                         </div>
                         ...
                         <div className="flex flex-col h-full p-6 bg-[var(--bg-secondary)]/40 border border-[var(--border-color)] hover:border-[var(--accent)] rounded-2xl transition-all duration-500 hover:shadow-xl relative">
                             ...
                             <div className="flex justify-between items-start mb-6">
                                 <div className="flex items-center gap-2">
                                     ...
                                     <div>
                                         ...
                                         <span className="block text-[9px] font-mono text-[var(--text-muted)] uppercase">2026 Edition</span>
                                     </div>
                                 </div>
                             ...
                             {cert.verifyUrl !== '#' && (
                                 <a 
                                     ...
                                     className="w-full py-2.5 bg-[var(--accent)] text-[var(--bg-primary)] font-bold text-center text-xs uppercase tracking-widest rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center gap-1.5"
                                 >
