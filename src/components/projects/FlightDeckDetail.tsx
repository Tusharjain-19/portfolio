...
export default function FlightDeckDetail() {
  ...
  return (
    <article className="min-h-screen text-(--text-primary) pb-20 selection:bg-sky-500/20 selection:text-sky-400">
      ...
      <header className="relative py-16 md:py-24 border-b border-(--border-color) overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10 text-center md:text-left">
          <Link href="/projects" className="inline-flex items-center gap-1.5 text-xs font-mono text-(--text-muted) hover:text-sky-400 transition-colors mb-8 uppercase tracking-widest">
            <ArrowLeft className="w-3.5 h-3.5" /> Back to Archives
          </Link>
          
          <div className="mb-4 inline-block px-3 py-1 bg-sky-500/10 border border-sky-500/30 rounded-full">
            <span className="text-[10px] font-mono uppercase tracking-widest text-sky-600 dark:text-sky-400 font-semibold">
